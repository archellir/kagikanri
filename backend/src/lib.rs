...
// Re-export the main router function for testing
use axum::{
    middleware,
...
async fn serve_spa() -> impl axum::response::IntoResponse {
...
async fn serve_assets(axum::extract::Path(file): axum::extract::Path<String>) -> impl axum::response::IntoResponse {
